  ...
  return <Main>
    <Container className={styles.container}>
      <MetaTags>
        ...
        <meta name="description" content={user ? `Product Aaaiatant - ${user.first_name} ${user.last_name}` : 'Product Assistant - User Page'} />
      ...
      >
        {subscribed ? 'Unsubscribe from the author' : 'Subscribe to the author'}
      </Button>}
      <CardList>
