...
const RecipeEdit = ({ onItemDelete }) => {
  ...
  return <Main>
    <Container>
      <MetaTags>
        <title>Editing a recipe</title>
        <meta name="description" content="Food Assistant - Editing a Recipe" />
        <meta property="og:title" content="Editing a recipe" />
      </MetaTags>
      <Title title='Editing a recipe' />
      <Form
